            ...
            if (count($row) >= 17) {
                ...
                if (!empty($noRekamMedik)) {
                    ...
                    if ($pasien) {
                        ...
                        if (!empty($jenisPasien) && strtolower($pasien->jenis_pasien) !== strtolower($jenisPasien)) {
                            $pasien->jenis_pasien = $jenisPasien;
                            $updated = true;
                        }
                        
                        // Update no_bpjs if different and valid
                        if (!empty($noBpjs) && $noBpjs !== '00000000000' && $pasien->no_bpjs !== $noBpjs) {
