<!-- Sidebar Component -->
<aside id="sidebar" class="sidebar w-64 text-white flex flex-col fixed lg:relative lg:translate-x-0 -translate-x-full transition-transform duration-300 ease-in-out z-50 h-screen lg:h-auto">
    <!-- Logo -->
