...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <div class="flex items-center justify-between">
            ...
            <div class="text-right">
                ...
                <p class="font-semibold text-green-600">{{ Auth::user()->roles->pluck('name')->first() }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            @if(Auth::user()->hasPermission('create-pasien'))
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center p-3 bg-gray-50 rounded-lg">
                ...
                <div class="flex-1">
                    <p class="text-sm font-medium text-gray-900">User "{{ Auth::user()->name }}" login</p>
                    <p class="text-xs text-gray-500">{{ now()->format('d M Y H:i') }}</p>
                </div>
            </div>
            <div class="flex items-center p-3 bg-gray-50 rounded-lg">
